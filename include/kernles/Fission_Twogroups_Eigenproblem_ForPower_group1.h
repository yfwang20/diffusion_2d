...
class Fission_Twogroups_Eigenproblem_ForPower_group1 : public EigenKernel
{
public:
    Fission_Twogroups_Eigenproblem_ForPower_group1(const InputParameters & parameters);
