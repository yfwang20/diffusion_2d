#include "Material_TWIGL_Twogroups_forTransientproblem2ofTWIGL.h"

registerMooseObject("diffusion_2DApp", Material_TWIGL_Twogroups_forTransientproblem2ofTWIGL);

InputParameters Material_TWIGL_Twogroups_forTransientproblem2ofTWIGL::validParams()
{
...
Material_TWIGL_Twogroups_forTransientproblem2ofTWIGL::Material_TWIGL_Twogroups_forTransientproblem2ofTWIGL(const InputParameters & parameters)
    :   Material(parameters),
...
void Material_TWIGL_Twogroups_forTransientproblem2ofTWIGL::computeQpProperties()
{
